...
/**
 * @ngdoc function
 * @name diffusionApp.controller:ResultsCtrl
 * @description
 * # ResultsCtrl
 * Controller of the diffusionApp
 */
angular.module('diffusionApp')
    .controller('ResultsCtrl', ['$scope', '$rootScope', '$routeParams', '$filter', 'ApiInterface', 'ngTableParams', function ($scope, $rootScope, $routeParams, $filter, ApiInterface, ngTableParams) {
